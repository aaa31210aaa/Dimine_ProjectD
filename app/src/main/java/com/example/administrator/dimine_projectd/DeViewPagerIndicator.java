...
public class DeViewPagerIndicator extends LinearLayout {
    /**
     * 绘制三角形的画笔
     */
    ...
    public DeViewPagerIndicator(Context context) {
        this(context, null);
    }

    public DeViewPagerIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
