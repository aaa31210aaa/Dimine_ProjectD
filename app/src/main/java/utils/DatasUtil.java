...
public class DatasUtil {
    public static final String[] CONTENTS = {"", "哈哈", "今天是个好日子", "呵呵", "图不错",
            "我勒个去"};
    public static String[] create_time = {"12月24日", "昨天", "8小时前", "6小时前", "12月24日", "昨天", "8小时前", "6小时前", "12月24日", "昨天", "8小时前", "6小时前", "12月24日", "昨天", "刚刚"};
...
//            "http://pic2.ooopic.com/11/79/98/31bOOOPICb1_1024.jpg"};
    ...
    public static List<CircleItem> createCircleDatas() {
        ...
        for (int i = 0; i < 15; i++) {
            ...
            item.setCreateTime(create_time[i]);
